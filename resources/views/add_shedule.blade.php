                ...
                <div class="card-body">
                  ...
                  <form method="post"  class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" name="academic_year" placeholder="Enter Acedmic Year">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">School Level</label>
                      <input type="text" class="form-control" name="school_level" id="" placeholder="School Level">
                    </div>
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="teacher_sure_name" name="sure_name"
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="teacher_speciality" name="teacher_speciality"
                    ...
                    <div class="form-group">
                        <label for="exampleInputPassword4">Teacher Cell Number</label>
                        <input type="text" class="form-control" id="teacher_number" name="teacher_number" placeholder="Teacher Cell No">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Day	</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="day" placeholder="Day ">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Periods	</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="periods" placeholder="Periods ">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Class Name	</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="class_name" placeholder="Class Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Sub Class Name	</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="sub_class_name" placeholder="Sub Class Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Semester Number	</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="semester_number" placeholder="Semester Number">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Subjects	</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="subjects" placeholder="subjects">
                      </div>
