            ...
            <div class="col-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form method="post" action="{{ url('store_data') }}"  class="forms-sample">
                    @csrf

                    <div class="form-group">
                      <label for="exampleInputPassword4">Teacher Name</label>
                      <input type="text" class="form-control" id="exampleInputPassword4" name="teacher_name" placeholder="Teacher Name">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">Teacher Nick Name</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="nickname" placeholder="Teacher Cell No">
                      </div>
                    <div class="form-group">
                        <label for="exampleInputPassword4">Teacher Sure Name</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="sure_name" placeholder="Teacher Sure Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Teacher Line	</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="teacher_line" placeholder="Teacher Line">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Teacher Speciality	</label>
                        <input type="text" class="form-control" id="exampleInputPassword4" name="teacher_speciality" placeholder="Teacher Speciality ">
                      </div>
                    <div class="form-group">
